          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                if($partytimes){
                    $i=1;
                  foreach($partytimes as $dinfo){
                  // var_dump($dinfo)
                  $dinfo->select_date = strtotime($dinfo->select_date);
                  $date = date("d-m-Y", $dinfo->select_date);
                  ...
                  <tr>
                   ...
                   <td><?=$dinfo->occation?></td>
                   <td><?=$date?></td>
                   <td><?=$dinfo->from_time?></td>
                   <td><?=$dinfo->to_time?></td>
                   <td><?=$dinfo->no_of_people?></td>
                   <td><?=$dinfo->package_name?></td>
                   <td><?=$dinfo->total_package_amount?></td>
