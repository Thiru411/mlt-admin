              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?=$info->Items_categoryname?></td>
                    <td><?=$info->item_name?></td>
                    <td><?=$info->display_name?></td>
                    <?php
                                if($info->item_onboarding_status==1){?>
                                  <td><a href="<?php echo base_url('items/item-config/'.$info->sk_id );?>">Edit</a> 
                                  <a href="<?php echo base_url('items/itemlistedit/delete/'.$info->sk_id);?>">Delete</a></td>

                   <?php }else{ ?>
                  <td><a href="<?php echo base_url('items/itemlistedit/active/'.$info->sk_id);?>">Active</a></td>
                 <?php }?>
