                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                           ...
                           <?php foreach($getdesignation as $info){
                               $name=$info->designation_name;}
                               ?>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="<?php echo base_url('org/designationEdit/update')?>" method="post">
                                <div class="card-body row">
       <input type="hidden" name="id" value="<?=$id?>">
                                <div class="form-group col-md-12">
                                    <label for="exampleInputEmail1">Designation</label>
                                    <input type="text" name="designation" class="form-control" value="<?=$name?>" id="designation" placeholder="Enter Designation" required>
                                </div>
